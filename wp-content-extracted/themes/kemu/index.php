...
<div class="container" style="background-color:white;">
    ...
    <div class="row" style="    padding: 1%;">
                ...
                <div class="sub-content">
                    <h6 class="h-sub-content">
                        <p >
                            <strong>
                                <?php
                        $ver= ($index == 1 )? "Current Journal": "Previous RESEARCH";
            ...
            <div class="col-md-6 col-sm-6 col-xm-12">
                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/tt.jpg"  alt="client" />
            </div>
            <?php
...
<!--        </div>-->
    ...
    <div class="row" style="    padding: 1%;">
        ...
        <div class="col-md-6 col-sm-6 col-xm-12">
            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/EditorialBoard.jpg" style="height: 300px;" alt="client" />
        </div>
        <?php
  ...
  <div class="row"  style="background: white; padding: 1%;">
    ...
    <div class="row text-center services" style="background: white;padding: 1%;">
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
            ...
            <h4><a href="<?=WP_SITEURL .'/add-submission'?>">New Submission</a></h4>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                    <span class="fa-stack fa-4x">
                            <i class="fa fa-square fa-stack-2x"></i>
            ...
            <h4><a href="<?=WP_SITEURL .'/'?>">Current Issue</a></h4>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                    <span class="fa-stack fa-4x">
                           <i class="fa fa-square fa-stack-2x"></i>
            ...
            <h4> <a href="<?=WP_SITEURL .'/archives'?>">Archives</a></h4>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                    <span class="fa-stack fa-4x">
                             <i class="fa fa-square fa-stack-2x"></i>
            ...
            <h4> <a href="<?php echo  get_template_directory_uri() .'/downloads'?>/AuthorGuideline.pdf">Instructions for Authors</a></h4>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                    <span class="fa-stack fa-4x">
                          <i class="fa fa-square fa-stack-2x"></i>
            ...
            <h4><a href="<?php echo  get_template_directory_uri() .'/downloads'?>/Copyrights.pdf">Copyrights</a></h4>
        </div>
