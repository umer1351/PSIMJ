    ...
    <div class="container" style="background-color:white;">
        ...
        <div class="row" >
            <div class="col-md-3 col-sm-3 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img style="width:250px;" src="https://psimj.com/public/advisors/advisor.jpg" alt="teacher">
                    </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/advisors/advisor2.jpg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/advisors/advisor3.jpg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/tasleem.jpeg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
                        <h2>Dr. Tasleem Akhtar</h2>
                        <h4>Ex- Chairperson PMRC, Ex-Consultant Research &amp; Development, KMU. Pediatrician by profession but dedicated to research.</h4>
                        <!--<ul>-->
                        <!--    <li><a href="https://www.facebook.com/devitems/?ref=bookmarks"><i class="zmdi zmdi-facebook"></i></a></li>-->
                        <!--    <li><a href="https://www.pinterest.com/devitemsllc/"><i class="zmdi zmdi-pinterest"></i></a></li>-->
                        <!--    <li><a href="#"><i class="zmdi zmdi-vimeo"></i></a></li>-->
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/advisors/advisor5.jpg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/naghmarehan.jpeg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/bikharam1.jpeg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <img src="https://psimj.com/public/profwaqar.jpeg" alt="teacher">
                    </div>
                    <div class="single-teacher-content text-center">
