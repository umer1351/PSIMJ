    ...
    if( $orientation == 'hor' ) {
        ...
        if($custom_theme == 'custom'){
            ...
            if( get_option('mo_openid_print_share_enable') ) {
                if ($sharing_counts){$html .= "<li>";} $html .= "<a rel='nofollow' title='Print this page' onclick='javascript:window.print();' class='mo-openid-share-link' style='margin-left : " .($spaceBetweenIcons) . "px !important'><i class='mo-custom-share-icon " .$selected_theme. " far fa-file-alt' style='padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            ...
            if (get_option('mo_openid_print_share_enable')) {
                if ($sharing_counts){$html .= "<li style='line-height: 0.0px'>";} $html .= "<a rel='nofollow' title='Print this page' onclick='javascript:window.print();' class='mo-openid-share-link' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><i class=' " . $selected_theme . " far fa-file-alt' style='padding-top:4px;text-align:center;color:" . $fontColor . ";font-size:" . $sharingSize . "px !important;height:" . $sharingSize . "px !important;width:" . $sharingSize . "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            if (get_option('mo_openid_whatsapp_share_enable')) {
                if (wp_is_mobile()) {
            ...
            if( get_option('mo_openid_pinterest_share_enable') ) {
                if ($sharing_counts){
                    $html .= "<li style='line-height: 0.0px'>";} $html .= "<a rel='nofollow' title='reddit' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link' style='margin-left : " .($spaceBetweenIcons) . "px !important'><i class='mo-custom-share-icon " .$selected_theme. " fab fa-pinterest' style='padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:" .$default_color['pinterest']. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            ...
            if( get_option('mo_openid_mail_share_enable') ) {
                if ($sharing_counts){$html .= "<li style='line-height: 0.0px'>";}  $html .= "<a rel='nofollow' title='Envelope' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link' style='margin-left : " .($spaceBetweenIcons) . "px !important'><i class='mo-custom-share-icon " .$selected_theme. " far fa-envelope' style='padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:" .$default_color['email']. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            if( get_option('mo_openid_print_share_enable') ) {
                if ($sharing_counts){$html .= "<li style='line-height: 0.0px'>";}  $html .= "<a rel='nofollow' title='Print' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link' style='margin-left : " .($spaceBetweenIcons) . "px !important'><i class='mo-custom-share-icon " .$selected_theme. " far fa-file-alt' style='padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:" .$default_color['print']. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            if( get_option('mo_openid_whatsapp_share_enable') ) {
...
function mo_openid_vertical_share_shortcode( $atts = '', $title = '', $excerpt = '' ) {
    ...
    if($custom_theme == 'custom'){
        ...
        if( get_option('mo_openid_print_share_enable') ) {
            $html .= "<a rel='nofollow' title='Print this page' onclick='javascript:window.print();' class='mo-openid-share-link' ><i class='mo-custom-share-icon " .$selected_theme. " far fa-file-alt' style='margin-bottom : " . ($spaceBetweenIcons-4) . "px !important;padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;'></i></a>";
        }
        if( get_option('mo_openid_whatsapp_share_enable') ) {
            if(wp_is_mobile()){
        ...
        if( get_option('mo_openid_print_share_enable') ) {
            $html .= "<a rel='nofollow' title='Print this page' onclick='javascript:window.print();' class='mo-openid-share-link' ><i class='far fa-file-alt' style='margin-bottom : " . ($spaceBetweenIcons-4) . "px !important;padding-top:4px;text-align:center;color:" .$fontColor . ";font-size:" .$sharingSize. "px !important;height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;'></i></a>";
        }
        if( get_option('mo_openid_whatsapp_share_enable') ) {
            if(wp_is_mobile()){
