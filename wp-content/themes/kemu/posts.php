...
<head>
    ...
    <style>
        .customStyle .clearfix.spacer01 {
            clear: both;
            height: 1px;
        }
        .customStyle .obj_article_summary.clearfix {
            min-height: 180px;
        }
        section.current_issue.noborder{
    ...
    <div class="pkp_structure_content has_sidebar">
        <div class="pkp_structure_main" role="main">
            ...
            <div class="page_index_journal">
                ...
                <section class="current_issue noborder" style="padding:unset!important">
...
<!--                    </h2>-->
                    ...
                    <?php
						...
						//$categories=array_slice($categories, 1, 5, true);
...
<div class="current_issue_title">
                                <?php echo $parentCatName = get_cat_name($categories[$i]->parent); ?> -  <?php echo $categories[$i]->cat_name ?>
                            </div>
                        <div class="heading">
...
<!--				</span>-->
                            ...
                            <div class="clearfix spacer01"></div>
                        </div>
<div class="clearfix spacer01"></div>
                        ...
                        <div class="sections">
                            <div class="section">
                                ...
                                <ul class="cmp_article_list articles customStyle">
                                <?php
                                $cat_id =$categories[$i]->cat_ID ;
                                $args = array( 'posts_per_page' => 25, 'offset'=> 0, 'category' => $cat_id,'order' => 'ASC');
                                ...
                                foreach ($myposts as $post){
                                    ...
                                    <li class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="obj_article_summary clearfix">

                                            <div class="title">
                                                <a id="article-4365" href="https://psimj.com/article?post-slug=<?php echo $post->ID?>?>">
                                                 <?php
...
//                                                 else
                                            ...
                                            <div class="meta">
                                                <div class="authors">
                                                    Author-	<?php echo   $arr= get_post_meta( $post->ID, 'post_authors', true );;
...
<!--                    <a href="annals/issue/archive.html" class="read_more">-->
<!--                        View All Issues-->
<!--                    </a>-->
