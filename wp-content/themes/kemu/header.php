...
<head>
    ...
    <meta name="keywords" content="Annals, Pakistan, society, internal, medicine, journal" />
    <meta name="description" content=" PSIMJ is a website used to view and download abstract or PDF of latest journals and articles." />
    <meta name="Author" content="PSIMJ" />
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/classes/style.css" rel="stylesheet" type="text/css" />
    <!-- PAGE LEVEL SCRIPTS -->
    ...
    <link rel='shortcut icon' type='image/x-icon' href='images/favicon.ico' />
	 <link rel="icon" href="https://psimj.com/public/favicon.png" type="image/gif" sizes="16x16">
    <!-- CUSTOM CSS FILES -->

    <title>JPSIM JOURNALS</title>
    <?php wp_head(); ?>
    <style>
        .logo img {
