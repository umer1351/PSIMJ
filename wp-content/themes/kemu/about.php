...
<div class="col-md-3 col-sm-4 col-xs-12 thumbwidth">
                <div class="single-teacher mb-45">
                    <div class="single-teacher-img">
                        <a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/3.jpg" alt="teacher"></a>  
                    </div>
                    <!-- <div class="single-teacher-content text-center">
                        <h3><a href="">Prof. Javed Akram </a></h3>
                        <h4>President - PSIM <br> Editor in  Chief - JPSIM</h4>
