...
<head>
    ...
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Montserrat:400,700|Noto+Serif:400,400i,700,700i" type="text/css" /><link rel="stylesheet" href="../public/journals/1/styleSheet9c2a.css?v=3.2.0.2" type="text/css" />
<style>
.abstract {
    font-size: 17px;
...
.value{
	open_sansregular,Verdana, Arial , Helvetica , sans-serif !important
}
</style>
</head>
            ...
            <div class="page page_article">
                <nav class="cmp_breadcrumbs" role="navigation" aria-label="You are here:">
                    <ol>
                        ...
                        <li>
                            <a href="https://www.annalskemu.org/journal/index.php/annals/issue/archive">
                                Archives
                            </a>
                            <span class="separator">/</span>
                        </li>
<!--                        <li>-->
<!--                            <a href="https://www.annalskemu.org/journal/index.php/annals/issue/view/129">-->
<!--                                Vol. 27 No. 1 (2021): AKEMU-->
<!--                            </a>-->
<!--                            <span class="separator">/</span>-->
<!--                        </li>-->
			...
			<span aria-current="page">
                        ...
                        <div class="main_entry">
                            ...
                            <section class="item authors">
                                ...
                                <ul class="authors">
                                    ...
                                    <li>
							<span class="name">
								  author-	<?php  $arr= get_post_meta( $post_7->ID, 'post_authors', true );;
                            ...
                            <section class="item keywords">
                                ...
                                <span class="value">
										 	<?php echo $keywords= get_post_meta( $post_7->ID, 'keywords', true );?>							</span>
                            </section>

                            <section class="item abstract">
                                <h2 class="label">Abstract</h2>
               	<?php echo $abstract= get_post_meta( $post_7->ID, 'abstract', true );
				 $methods= get_post_meta( $post_7->ID, 'methods', true );
				$result= get_post_meta( $post_7->ID, 'result', true );
				$conclusion= get_post_meta( $post_7->ID, 'consclusion', true );
				$case= get_post_meta( $post_7->ID, 'case_presentation', true );
				$treatment= get_post_meta( $post_7->ID, 'treatment_course', true )
				
				?>
			      <?php 
				  if (!empty($methods)) {
				  echo '<br><h3 class="label">Methods</h3>';
			      echo $methods;
				  }
				  ?>
			    <?php 
				 if (!empty($result)) {
				  echo '<br>	<h3 class="label">Results</h3>&nbsp';
			      echo $result;
				  }
				  ?>
				      <?php 
				if (!empty($result)) {
				  echo '<br>	<h3 class="label">Conclusion</h3>&nbsp';
			      echo $conclusion;
				  }
				  ?>
			 <?php 
				if (!empty($case)) {
				  echo '<br>	<h3 class="label">Case Presentation</h3>&nbsp';
			      echo $case;
				  }
				  ?>
			 ...
			 <?php 
				if (!empty($treatment)) {
				  echo '<br>	<h3 class="label">Treatment Course</h3>&nbsp';
			      echo $treatment;
				  }
				  ?>
                            ...
                            <div class="item published">
                                <section class="sub_item">
                                    ...
                                    <div class="value">
										...
										$date=date_create($post_7->post_date);
echo date_format($date,"Y/m/d");   
                                ...
                                <section class="sub_item">
                                    ...
                                    <div class="value">
                                        <a class="title" href="">
											...
											$terms = wp_get_post_terms( $post_7->ID , 'category', array("fields" => "all") );
											//print_r($terms[1]);
											echo $terms[1]->name .'-' . $terms[0]->name
											?>
                                        </a>
                                    </div>
                                </section>
                            ...
                            <div class="item copyright">
                                ...
                                <p>This is an open-access journal and all the published articles / items are distributed under the terms of the&nbsp;
								<a href="http://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution License</a>,
								which permits unrestricted use, distribution, and reproduction in any medium, provided the original
								author and source are credited. For comments <a href="mailto psimjournal@gmail.com" target="_blank" rel="noopener">
								 psimjournal@gmail.com</a></p>
                            </div>
